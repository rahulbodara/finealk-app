...
export default function FranchiesBottleList(props) {
  ...
  const Add = () => {
    props.navigation.navigate('AddFranchiesBottleList');
  };
          ...
          return (
            <View key={i}>
              <View style={Style.franchieslistView}>
                ...
                <TouchableOpacity
                  onPress={() =>
                    props.navigation.navigate('ViewFranchiesBottleList', {
                      id: detail._id,
                    })
                  }>
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    props.navigation.navigate('EditFranchiesBottleList', {
                      id: detail._id,
